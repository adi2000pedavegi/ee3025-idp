...
\begin{lstlisting}
https://github.com/adi2000pedavegi/ee3025-idp/tree/master/Assignment-1-fft/codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/adi2000pedavegi/ee3025-idp/tree/master/Assignment-1-fft
\end{lstlisting}
...
\begin{align}
    y\brak{n} = fft\brak{Y\brak{K}}
\end{align}
where $y(n)$ is time domain output signal
\section{Computing using fft algorithm in both python}
Below is the following python code implementing fft algorithm in python
\begin{lstlisting}
codes/ee18btech11034-fft.py
\end{lstlisting}
Plotting the time domain output signal obtained from fft in python and constructing the audio file
Below is the audio file for the above output y(n)
\begin{lstlisting}
codes/7.1_Sound_With_ReducedNoise_using_python.wav
\end{lstlisting}
\begin{figure}[!h]
\centering
...
Storing the input signal x(n) and transfer function Hz in .dat files for loading into C code
Below is the following python code for storing the data
\begin{lstlisting}
codes/ee18btech11034-fft-data.py
\end{lstlisting}
Executing the following code in C to get output y(n)
\begin{lstlisting}
codes/ee18btech11034-fft.c
\end{lstlisting}
Plotting the time domain output signal obtained from fft in C and constructing audio file
\begin{lstlisting}
codes/ee18btech11034-fft-output.py
\end{lstlisting}
Below is the audio file for the above output y(n)
\begin{lstlisting}
